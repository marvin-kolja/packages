...
class PlatformDeviceFormat {
  ...
  PlatformVideoDimensions dimensions;

  List<PlatformFrameRateRange?> frameRateRanges;
  ...
  static PlatformDeviceFormat decode(Object result) {
    result as List<Object?>;
    return PlatformDeviceFormat(
      dimensions: result[0]! as PlatformVideoDimensions,
      frameRateRanges:
          (result[1] as List<Object?>?)!.cast<PlatformFrameRateRange?>(),
      mediaType: result[2]! as String,
      mediaSubType: result[3]! as String,
      hdr: result[4]! as bool,
    );
  }
}
...
class PlatformVideoDimensions {
  ...
  static PlatformVideoDimensions decode(Object result) {
    result as List<Object?>;
    return PlatformVideoDimensions(
...
class CameraApi {
  ...
  Future<List<PlatformDeviceFormat?>> getAvailableDeviceFormats(
    ...
    final String __pigeon_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.getAvailableDeviceFormats$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
