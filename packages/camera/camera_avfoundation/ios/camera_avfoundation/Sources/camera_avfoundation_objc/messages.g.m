...
@interface FCPPlatformFrameRateRange ()
+ (FCPPlatformFrameRateRange *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformFrameRateRange *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface FCPPlatformDeviceFormat ()
+ (FCPPlatformDeviceFormat *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformDeviceFormat *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@interface FCPPlatformVideoDimensions ()
+ (FCPPlatformVideoDimensions *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformVideoDimensions *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FCPPlatformFrameRateRange
+ (instancetype)makeWithMin:(double)min max:(double)max {
  FCPPlatformFrameRateRange *pigeonResult = [[FCPPlatformFrameRateRange alloc] init];
...
+ (nullable FCPPlatformFrameRateRange *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformFrameRateRange fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.min),
...
@implementation FCPPlatformDeviceFormat
+ (instancetype)makeWithDimensions:(FCPPlatformVideoDimensions *)dimensions
                   frameRateRanges:(NSArray<FCPPlatformFrameRateRange *> *)frameRateRanges
                         mediaType:(NSString *)mediaType
                      mediaSubType:(NSString *)mediaSubType
                               hdr:(BOOL)hdr {
  FCPPlatformDeviceFormat *pigeonResult = [[FCPPlatformDeviceFormat alloc] init];
  pigeonResult.dimensions = dimensions;
  pigeonResult.frameRateRanges = frameRateRanges;
  pigeonResult.mediaType = mediaType;
  pigeonResult.mediaSubType = mediaSubType;
  pigeonResult.hdr = hdr;
  return pigeonResult;
}
+ (FCPPlatformDeviceFormat *)fromList:(NSArray<id> *)list {
  FCPPlatformDeviceFormat *pigeonResult = [[FCPPlatformDeviceFormat alloc] init];
  pigeonResult.dimensions = GetNullableObjectAtIndex(list, 0);
  pigeonResult.frameRateRanges = GetNullableObjectAtIndex(list, 1);
  pigeonResult.mediaType = GetNullableObjectAtIndex(list, 2);
  pigeonResult.mediaSubType = GetNullableObjectAtIndex(list, 3);
  pigeonResult.hdr = [GetNullableObjectAtIndex(list, 4) boolValue];
  return pigeonResult;
}
+ (nullable FCPPlatformDeviceFormat *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformDeviceFormat fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.dimensions ?: [NSNull null],
    self.frameRateRanges ?: [NSNull null],
    self.mediaType ?: [NSNull null],
    self.mediaSubType ?: [NSNull null],
    @(self.hdr),
  ];
}
@end
...
@implementation FCPPlatformVideoDimensions
+ (instancetype)makeWithWidth:(NSInteger)width height:(NSInteger)height {
  FCPPlatformVideoDimensions *pigeonResult = [[FCPPlatformVideoDimensions alloc] init];
...
+ (nullable FCPPlatformVideoDimensions *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformVideoDimensions fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.width),
...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.camera_avfoundation."
                                                   @"CameraApi.getAvailableDeviceFormats",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getAvailableDeviceFormats:completion:)],
                @"FCPCameraApi api (%@) doesn't respond to "
                @"@selector(getAvailableDeviceFormats:completion:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSString *arg_cameraName = GetNullableObjectAtIndex(args, 0);
        [api getAvailableDeviceFormats:arg_cameraName
                            completion:^(NSArray<FCPPlatformDeviceFormat *> *_Nullable output,
                                         FlutterError *_Nullable error) {
                              callback(wrapResult(output, error));
                            }];
      }];
