...
@class FCPPlatformFrameRateRange;
@class FCPPlatformDeviceFormat;
@class FCPPlatformCameraState;
@class FCPPlatformMediaSettings;
@class FCPPlatformVideoDimensions;
...
@interface FCPPlatformDeviceFormat : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithDimensions:(FCPPlatformVideoDimensions *)dimensions
                   frameRateRanges:(NSArray<FCPPlatformFrameRateRange *> *)frameRateRanges
                      ...
                      mediaSubType:(NSString *)mediaSubType
                               hdr:(BOOL)hdr;
@property(nonatomic, strong) FCPPlatformVideoDimensions *dimensions;
@property(nonatomic, copy) NSArray<FCPPlatformFrameRateRange *> *frameRateRanges;
@property(nonatomic, copy) NSString *mediaType;
@property(nonatomic, copy) NSString *mediaSubType;
...
@interface FCPPlatformVideoDimensions : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
- (void)setImageFileFormat:(FCPPlatformImageFileFormat)format
                completion:(void (^)(FlutterError *_Nullable))completion;
- (void)getAvailableDeviceFormats:(NSString *)cameraName
                       completion:(void (^)(NSArray<FCPPlatformDeviceFormat *> *_Nullable,
                                            FlutterError *_Nullable))completion;
@end
