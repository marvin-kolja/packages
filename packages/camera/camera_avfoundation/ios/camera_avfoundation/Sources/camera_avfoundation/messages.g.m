...
+ (FCPPlatformFrameRateRange *)fromList:(NSArray *)list;
+ (nullable FCPPlatformFrameRateRange *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end

@interface FCPPlatformDeviceFormat ()
+ (FCPPlatformDeviceFormat *)fromList:(NSArray *)list;
+ (nullable FCPPlatformDeviceFormat *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
+ (FCPPlatformVideoDimensions *)fromList:(NSArray *)list;
+ (nullable FCPPlatformVideoDimensions *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
